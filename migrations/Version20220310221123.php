 ...
 */
final class Version20220310221123 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE quote CHANGE date_quote date_quote VARCHAR(50) NOT NULL');
    }
