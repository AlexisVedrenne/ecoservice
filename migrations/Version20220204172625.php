 ...
 */
final class Version20220204172625 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE admin (id INT AUTO_INCREMENT NOT NULL, first_name VARCHAR(50) NOT NULL, last_name VARCHAR(50) NOT NULL, mail VARCHAR(50) NOT NULL, password VARCHAR(50) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE card (id INT AUTO_INCREMENT NOT NULL, card_type_id INT DEFAULT NULL, particulier_id INT DEFAULT NULL, number_card VARCHAR(50) NOT NULL, name_card VARCHAR(50) NOT NULL, expiration_date DATE NOT NULL, INDEX IDX_161498D3925606E5 (card_type_id), INDEX IDX_161498D3A89E0E67 (particulier_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE commentary (id INT AUTO_INCREMENT NOT NULL, particulier_id INT DEFAULT NULL, product_id INT DEFAULT NULL, comment VARCHAR(255) NOT NULL, INDEX IDX_1CAC12CAA89E0E67 (particulier_id), INDEX IDX_1CAC12CA4584665A (product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE commercial (id INT AUTO_INCREMENT NOT NULL, first_name VARCHAR(50) NOT NULL, last_name VARCHAR(50) NOT NULL, mail VARCHAR(50) NOT NULL, password VARCHAR(50) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE order_product (id INT AUTO_INCREMENT NOT NULL, payment_id INT DEFAULT NULL, particulier_n_id INT DEFAULT NULL, date_order DATE NOT NULL, quantity_product VARCHAR(50) NOT NULL, particulier VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_2530ADE64C3A3BB (payment_id), INDEX IDX_2530ADE6C7D42D61 (particulier_n_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE particulier (id INT AUTO_INCREMENT NOT NULL, first_name VARCHAR(50) NOT NULL, lastt_name VARCHAR(50) NOT NULL, mail VARCHAR(50) NOT NULL, password VARCHAR(50) NOT NULL, tel VARCHAR(11) NOT NULL, city VARCHAR(50) NOT NULL, cp VARCHAR(6) NOT NULL, adress VARCHAR(50) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE payment (id INT AUTO_INCREMENT NOT NULL, card_id INT DEFAULT NULL, first_name VARCHAR(50) NOT NULL, last_name VARCHAR(50) NOT NULL, mail VARCHAR(50) NOT NULL, password VARCHAR(50) NOT NULL, tel VARCHAR(11) NOT NULL, country VARCHAR(50) NOT NULL, city VARCHAR(50) NOT NULL, cp VARCHAR(6) NOT NULL, adress VARCHAR(50) NOT NULL, des VARCHAR(50) NOT NULL, total_price VARCHAR(50) NOT NULL, INDEX IDX_6D28840D4ACC9A20 (card_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, category_poduct_id INT DEFAULT NULL, image VARCHAR(50) NOT NULL, des VARCHAR(50) NOT NULL, ref VARCHAR(50) NOT NULL, price VARCHAR(50) NOT NULL, quantity VARCHAR(255) NOT NULL, state TINYINT(1) NOT NULL, recycling_index VARCHAR(50) NOT NULL, INDEX IDX_D34A04AD5FD865AC (category_poduct_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE quote (id INT AUTO_INCREMENT NOT NULL, name_commercial_id INT DEFAULT NULL, name_professional VARCHAR(50) NOT NULL, status TINYINT(1) NOT NULL, date_quote DATE NOT NULL, total_price VARCHAR(50) NOT NULL, INDEX IDX_6B71CBF42AB3839A (name_commercial_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE service (id INT AUTO_INCREMENT NOT NULL, category_service_id INT DEFAULT NULL, image VARCHAR(50) NOT NULL, des VARCHAR(50) NOT NULL, commentary VARCHAR(255) NOT NULL, INDEX IDX_E19D9AD2CB42F998 (category_service_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE product ADD CONSTRAINT FK_D34A04AD5FD865AC FOREIGN KEY (category_poduct_id) REFERENCES category_product (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product DROP FOREIGN KEY FK_D34A04AD5FD865AC');
