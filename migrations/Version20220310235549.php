 ...
 */
final class Version20220310235549 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE contact (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(30) NOT NULL, mail VARCHAR(50) NOT NULL, message LONGTEXT NOT NULL, objet VARCHAR(25) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE quote (id INT AUTO_INCREMENT NOT NULL, commercial_id INT DEFAULT NULL, name_professional VARCHAR(50) NOT NULL, status VARCHAR(30) NOT NULL, date_quote VARCHAR(50) NOT NULL, total_price VARCHAR(50) NOT NULL, mail VARCHAR(50) NOT NULL, numero VARCHAR(10) NOT NULL, city VARCHAR(50) NOT NULL, des VARCHAR(5000) NOT NULL, societe VARCHAR(50) NOT NULL, INDEX IDX_6B71CBF47854071C (commercial_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
