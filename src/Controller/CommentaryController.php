...
class CommentaryController extends AbstractController
{
     ...
     */
    public function new(Request $request, EntityManagerInterface $entityManager, ProductRepository $repo): Response
    {
     ...
     */
    public function edit(Request $request, Commentary $commentary, EntityManagerInterface $entityManager,ProductRepository $repo): Response
    {
        $form = $this->createForm(CommentaryType::class, $commentary);
        $form->handleRequest($request);
